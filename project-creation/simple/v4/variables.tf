...
variable "project_admin_group" {
  description = "Team responsible for administration of this project"
  type        = string
}
...
variable "project_apis_to_enable" {
  description = "List of APIs to enable for project"
  type = list(string)
}

variable "project_iam_roles_to_grant" {
  description = "List of IAM roles to grant to admin group and SA for project"
  type = list(string)
}